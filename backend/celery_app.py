...
CELERY_TASK_MODULES = (
    ...
    "backend.tasks.url_extract_tasks",
...
URL_EXTRACT_TASK_NAME = "backend.tasks.url_extract_tasks.run_url_extract_job"
...
if Celery is None:
    ...
    celery_app.conf.update(
        ...
        task_routes={
            ...
            URL_EXTRACT_TASK_NAME: {"queue": HEAVY_QUEUE_NAME},
