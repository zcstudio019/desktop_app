...
def run_personal_bank_statement_agent(
    ...
    try:
        ...
        account_name = str((accounts_meta[0] if accounts_meta else {}).get("account_name") or owner.get("name") or "")
        transactions = classify_transactions(transactions, account_name=account_name)
