...
def build_account_summary(
    ...
    summary = {
        ...
        "excluded_inflow_total": _round(internal_transfer_inflow + excluded_related_party_inflow + excluded_personal_inflow) or 0.0,
        "excluded_outflow_total": _round(internal_transfer_outflow + excluded_related_party_outflow + excluded_personal_outflow) or 0.0,
