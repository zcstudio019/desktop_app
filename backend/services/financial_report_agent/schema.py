...
class CashFlowStatement(BaseModel):
    ...
    cash_received_from_disposal_subsidiaries: AmountField = Field(default_factory=AmountField)
    other_cash_received_related_to_investing: AmountField = Field(default_factory=AmountField)
    ...
    cash_paid_for_acquisition_subsidiaries: AmountField = Field(default_factory=AmountField)
    other_cash_paid_related_to_investing: AmountField = Field(default_factory=AmountField)
    ...
    other_cash_received_related_to_financing: AmountField = Field(default_factory=AmountField)
    ...
    other_cash_paid_related_to_financing: AmountField = Field(default_factory=AmountField)
    ...
    effect_of_exchange_rate_changes: AmountField = Field(default_factory=AmountField)
