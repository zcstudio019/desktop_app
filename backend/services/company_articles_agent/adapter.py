...
class CompanyArticlesAgentAdapter(BaseDocumentAgent):
    agent_name = "company_articles_agent"
    supported_document_types = ["company_articles"]
    ...
    def extract(
        ...
        *,
        ...
        return DocumentAgentResult(
            ...
            confidence=0.9 if result.extraction_status == "success" else 0.72,
            extracted_json=content,
            markdown_summary=result.markdown,
            evidence=result.evidence,
            warnings=list(result.warnings),
            debug={"skill_name": "company_articles_skill", "normalized_document_type": DOC_TYPE},
