...
DOCUMENT_TYPE_DEFINITIONS: tuple[DocumentTypeDefinition, ...] = (
    ...
    DocumentTypeDefinition(
        code="bank_reconciliation_detail",
        name="银行对账明细",
        storage_label="银行对账明细",
        formats=("xlsx", "xls", "csv", "pdf"),
        aliases=("银行对账明细", "对账明细", "账户明细", "银行明细", "银行流水", "交易明细", "银行对账明细提取", "bank_reconciliation_detail"),
        store_original=True,
        store_markdown=True,
    ),
    DocumentTypeDefinition(
...
DOCUMENT_TYPE_CANONICAL_ALIASES = {
    ...
    "bank_reconciliation_detail": "bank_reconciliation_detail",
    "银行对账明细": "bank_reconciliation_detail",
    "对账明细": "bank_reconciliation_detail",
    "账户明细": "bank_reconciliation_detail",
    "银行明细": "bank_reconciliation_detail",
    "银行对账明细提取": "bank_reconciliation_detail",
