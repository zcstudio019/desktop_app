...
from config import DATA_TYPE_CONFIG, USE_LOCAL_STORAGE
...
feishu_service = None if USE_LOCAL_STORAGE else FeishuService()
...
async def _save_request(
    ...
    logger.info(
        ...
        "local" if USE_LOCAL_STORAGE else "feishu",
        backend_type,
    ...
    if USE_LOCAL_STORAGE:
        ...
        try:
            ...
            success, record_id, error_msg, _ = await _save_to_local_storage(
