...
预埋套管工程、弱电及消防报警预埋工程、防火封堵及抗震支架等机电安装工程施工及相关图纸深化、相关方案编制、评审等工作。
承包方式：包工包料（除甲供外）、包工期、包质量、包安全、包文明施工、包工程一切保险费、包环境保护、
包工程整体协调配合管理、包监测检测、包验收、包竣工验收备案、包维修保修。
计划开工日期：2022年10月1日，具体开工日期以承包人书面通知为准
计划竣工日期：2024年6月30日
合同工期：638天
...
"""
    ...
    assert "防火封堵及抗震支架等机电安装工程施工及相关图纸深化、相关方案编制、评审等工作" in markdown
    assert "包工程整体协调配合管理、包监测检测、包验收、包竣工验收备案、包维修保修" in markdown
