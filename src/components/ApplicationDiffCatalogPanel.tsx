          ...
          <div className="max-h-[60vh] space-y-3 overflow-y-auto pr-1">
            {activeDiffTarget ? (
              <div className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-3">
                ...
                <div className="text-sm font-medium text-slate-800">{activeDiffTarget.label}</div>
                <div className="mt-2 whitespace-pre-line rounded-lg border border-blue-100 bg-white px-3 py-2 text-[11px] leading-5 text-slate-600">
